    ...
    <section class="content col-xs-8" style="margin-left: 16.66666667% !important;">
        <div class="panel panel-default">
            <div class="panel-body">
                <?php
                $errors = get_instance()->session->flashdata('system_msg_contact');
                ...
                <?php endif; ?>
                <form action="<?php echo base_url('admin/forum/kategoriak/uj');?>" method="post" enctype="multipart/form-data">
