                        ...
                        <div class="panel-body">
                            <form id="message_details_nosubmit" action="javascript:void(0);">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="subject" value="<?php echo $message->msg_subject ?>" disabled="disabled" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="send_time" class="control-label">Feladás ideje</label>
                                    <input type="text" id="send_time" value="<?php echo $message->created_time ?>" disabled="disabled" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="message" class="control-label">Üzenet</label>
                                    <textarea id="message" class="form-control" contenteditable="false"><?php echo $message->msg_text ?></textarea>
                                </div>
                            </form>
                        </div>
                ...
                <div class="modal-body">
                    <form action="#" method="post" enctype="multipart/form-data" id="reply_form">
                        <div class="form-group">
                            ...
                            <input type="text" id="reply_subject" name="reply_subject" value="RE:<?php echo $message->msg_subject ?>" disabled="disabled" class="form-control">
                        </div>
                        <div class="form-group">
    ...
    <div class="modal fade" id="message-modal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="close_msg_modal" class="btn btn-primary form-control" data-dismiss="modal">OK</button>
                </div>
            </div>
        </div>
    </div>
