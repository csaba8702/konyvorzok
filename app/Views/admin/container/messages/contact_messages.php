                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <form id="received_msg">
                                <table id="admin_contact_messages" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="admin_contact_messages_info">
                                    <thead>
                                        <tr role="row">
                                            <th><input name="select_all" type="checkbox" title="Összes kijelölése"></th>
                                            <th tabindex="0" aria-controls="admin_contact_messages" rowspan="1" colspan="1" aria-sort="ascending">Megválaszolt</th>
                                            <th tabindex="0" aria-controls="admin_contact_messages" rowspan="1" colspan="1" aria-sort="ascending">Tárgy</th>
                                            <th tabindex="0" aria-controls="admin_contact_messages" rowspan="1" colspan="1" aria-sort="ascending">Feladó email</th>
                                            <th tabindex="0" aria-controls="admin_contact_messages" rowspan="1" colspan="1" aria-sort="ascending">Feladás ideje</th>
                                            <th tabindex="0" rowspan="1" colspan="1" aria-controls="admin_contact_messages">Műveletek</th>
                                        </tr>
                                    </thead>
                                </table>
                                <button type="button" id="delete_selected_messages" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Kijelöltek törlése</button>
        ...
        <div class="modal fade" id="message-modal" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" id="close_msg_modal" data-dismiss="modal">OK</button>
                    </div>
                </div>
            </div>
        </div>
