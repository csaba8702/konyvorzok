                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <form id="received_msg">
                                <table id="admin_sent_messages" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="admin_sent_messages_info">
                                    <thead>
                                    <tr role="row">
                                        <th><input name="select_all" type="checkbox" title="Összes kijelölése"></th>
                                        <th class="sorting_asc" tabindex="0" aria-controls="admin_sent_messages" rowspan="1" colspan="1" aria-sort="ascending">Megtekintve</th>
                                        <th class="sorting_asc" tabindex="0" aria-controls="admin_sent_messages" rowspan="1" colspan="1" aria-sort="ascending">Tárgy</th>
                                        <th class="sorting_asc" tabindex="0" aria-controls="admin_sent_messages" rowspan="1" colspan="1" aria-sort="ascending">Címzett</th>
                                        <th class="sorting_asc" tabindex="0" aria-controls="admin_sent_messages" rowspan="1" colspan="1" aria-sort="ascending">Feladás ideje</th>
