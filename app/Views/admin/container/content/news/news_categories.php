...
<div class="content-wrapper" xmlns="http://www.w3.org/1999/html">
    ...
    <section class="content-header">
        <div class="row">
            ...
            <div class="col-sm-8" style="margin-top: 1.75em;">
                <div class="pull-left">
                    <a href="<?php echo base_url('admin/tartalom/hirek/kategoriak/uj'); ?>" class="btn btn-primary"><i class="fa fa-plus-square" aria-hidden="true" style="margin: 2px;"></i> Új kategória</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="dataTables_wrapper form-inline dt-bootstrap">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <table id="admin_news_categories" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="admin_news_categories_info">
                                <thead>
                                    <tr role="row">
                                        <th><input name="select_all" type="checkbox"></th>
                                        <th class="sorting_asc" tabindex="0" aria-controls="admin_news_categories" rowspan="1" colspan="1" aria-sort="ascending">Cím</th>
                                        <th class="sorting_asc" tabindex="0" aria-controls="admin_news_categories" rowspan="1" colspan="1" aria-sort="ascending">Szülő kategória</th>
                                        <th tabindex="0" rowspan="1" colspan="1" aria-controls="admin_news_categories">Műveletek</th>
                                    </tr>
                                </thead>
                            </table>
